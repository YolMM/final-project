...
import { Button, FlexDiv, FormDiv, FormInput, PricesInp } from '../style/Style';
      ...
      <FlexDiv>
        <FormDiv>
          ...
          <PricesInp>
            ...
            <FormInput type="checkbox" value={state.prices.printed} onChange={() => (actions.updatePrinted())} placeholder="" />
          </PricesInp>
        </FormDiv>
