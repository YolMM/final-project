...
export const photoLists = async () => {
  ...
  const studioCollection = await Photos.create({
    name: 'Studio',
    images: ['/studio/dog2.jpg', '/studio/photowork5.jpg', '/studio/wp2.jpg', '/studio/fam1.jpg', '/studio/wp3.jpg', '/studio/mp2.jpg', '/studio/dog1.jpg', '/studio/cp2.jpg', '/studio/wp1.jpg', '/studio/wp5.jpg', '/studio/mp1.jpg', '/studio/fam2.jpg', '/studio/wp4.jpg'],
  });
